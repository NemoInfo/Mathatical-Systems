...
double drand(double min, double max){ //
    ...
    random_double = (float) rand() / (float) RAND_MAX; // note rand() only generates a 32-bit random number (no use casting to double) - could use drand48() to generate doubles
